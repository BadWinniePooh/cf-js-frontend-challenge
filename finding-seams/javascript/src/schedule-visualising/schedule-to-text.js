...
const SUPPORTED_LOCALES = ['en-US', 'en-GB', 'fi-FI', 'sv-SE', 'de-DE']
...
export class ScheduleToText {
  ...
  async convertToText(date, options = {}) {
    /**
    ...
    const locale = SUPPORTED_LOCALES.includes(options.locale) ? options.locale : 'en-US'
